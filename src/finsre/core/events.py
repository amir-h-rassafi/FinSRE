...
class EventType(StrEnum):
    ...
    SKU_USAGE_OBSERVED = "finsre.billing.sku_usage.observed"
    SKU_CLASSIFIED = "finsre.discovery.sku.classified"
    DISCOVERY_PROBES_PLANNED = "finsre.discovery.probes.planned"
    CONTEXT_FACT_RECORDED = "finsre.context.fact.recorded"
    QUESTION_PROPOSED = "finsre.context.question.proposed"
